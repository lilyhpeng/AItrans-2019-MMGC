...
NN_MODEL = "../results/summaryAndModel_20190516_v4/nn_model_ep_66000.ckpt"  # model path settings 94000,85000
...
class Algorithm:
    ...
    def run(self, time, S_time_interval, S_send_data_size, S_chunk_len, S_rebuf, S_buffer_size, S_play_time_len,
        ...
        bit_rate, target_buffer, latency_limit = self.getBitrateAndTargetbuffer(action_num)
        ...
        return bit_rate, target_buffer, LATENCY_LIMIT[latency_limit]

    # changed by penghuan on 20190509:
    def getActionNum(self, bit_rate, target_buffer,latency_limit):
