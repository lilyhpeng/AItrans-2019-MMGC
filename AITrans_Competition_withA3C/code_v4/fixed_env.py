...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, random_seed=RANDOM_SEED,
        ...
        # changed by penghuan on 20190516:
        self.file_list = ['../dataset/video_trace/AsianCup_China_Uzbekistan/frame_trace_',
                          # '../dataset/video_trace/Fengtimo_2018_11_3/frame_trace_',
                          # '../dataset/video_trace/YYF_2018_08_12/frame_trace_',
                          # '../dataset/video_trace/game/frame_trace_',
    ...
    def get_video_frame(self, quality, target_buffer, latency_limit):
        ...
        if end_of_video:
            ...
            # changed by penghuan on 20190516:
            # we can change a video file when current video finishes downloading:
            random_num = random.randint(0, 1)
            self.video_size_file = self.file_list[random_num]
            # #########################
            self.video_size = {}  # in bytes
            self.cdn_arrive_time = {}
            self.gop_time_len = {}
