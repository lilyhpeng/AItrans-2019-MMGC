...
NN_MODEL = "../results/summaryAndModel_20190605_all/nn_model_ep_188000.ckpt"  # model path settings
...
class Algorithm:
    ...
    def run(self, time, S_time_interval, S_send_data_size, S_chunk_len, S_rebuf, S_buffer_size, S_play_time_len,
        ...
        self.state[2, -1] = throughput_predict / 5
        self.state[3, -1] = rebuf_time / 10
...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            split_4 = tflearn.conv_1d(inputs[:, 4:5, :A_BIT_DIM], 128, 4, activation='relu')
            ...
            split_8 = tflearn.conv_1d(inputs[:, 8:9, :], 128, 4, activation='relu')
            ...
            merge_net = tflearn.merge([split_0_flat, split_1_flat, split_2_flat, split_3_flat, split_4_flat,
                                       split_5_flat, split_6_flat, split_7_flat, split_8_flat], 'concat')
