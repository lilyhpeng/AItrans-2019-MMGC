...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            merge_net = tflearn.merge([split_0_flat, split_1_flat, split_2_flat, split_3_flat, split_4_flat, split_5_flat, split_6_flat, split_7_flat, split_8_flat], 'concat')
    ...
    def create_critic_network(self):
        with tf.variable_scope('critic'):
            ...
            merge_net = tflearn.merge(
                [split_0_flat, split_1_flat, split_2_flat, split_3_flat, split_4_flat, split_5_flat, split_6_flat,
                 split_7_flat, split_8_flat], 'concat')
