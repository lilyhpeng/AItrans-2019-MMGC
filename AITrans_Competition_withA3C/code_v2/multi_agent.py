...
SUMMARY_DIR = './results/summaryAndModel_20190510'   # summary info(tensorboard to view) and model
# others:
#NN_MODEL = None
NN_MODEL = "./results/summaryAndModel_20190509/nn_model_ep_148000.ckpt"
DEBUG = False
DRAW = False
RANDOM_SEED = 42
random_seed = 2
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            for i in range(NUM_AGENTS):
                ...
                # added by cs
                if epoch < 20001:
                    ENTROPY_WEIGHT = 0.5#2
                elif epoch < 50001:
                    ENTROPY_WEIGHT = 0.3#1
                elif epoch < 70001:
                    ENTROPY_WEIGHT = 0.1#0.5
                elif epoch < 100001:
                    ENTROPY_WEIGHT = 0.05#0.3
                elif epoch < 160001:
                    ENTROPY_WEIGHT = 0.05#0.2
                elif epoch < 180001:
                    ENTROPY_WEIGHT = 0.1
                elif epoch < 200001:
                    ENTROPY_WEIGHT = 0.05
