...
NN_MODEL = "../results/summaryAndModel_20190527_low/nn_model_ep_180000.ckpt"
# NN_MODEL = "../results/summaryAndModel_20190527_medium/nn_model_ep_185000.ckpt"
# NN_MODEL = "../results/summaryAndModel_20190527_high/nn_model_ep_197000.ckpt"
# NN_MODEL = "../results/summaryAndModel_20190527_fixed/nn_model_ep_180000.ckpt"
...
class Algorithm:
    ...
    def run(self, time, S_time_interval, S_send_data_size, S_chunk_len, S_rebuf, S_buffer_size, S_play_time_len, S_end_delay,
        ...
        self.state[3, -1] = sum(S_rebuf[-50:]) / 10
        ...
        self.state[6, -1] = sum(S_skip_time[-50:])
