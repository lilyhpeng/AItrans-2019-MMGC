...
S_INFO = 7  # last 8 gop's bit_rate, buffer_size, last gop's download time, next_chunk_size, bandwidth_measurement(throughput and time), delay, fft
S_LEN = 8  # take how many frames in the past
A_DIM = 8  # modified by penghuan on 20181127
A_BIT_DIM = 4
...
SUMMARY_DIR = '../results/summaryAndModel_20190527_medium'   # summary info(tensorboard to view) and model
# others:
